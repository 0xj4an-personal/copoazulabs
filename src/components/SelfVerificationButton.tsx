      ...
      const app = new SelfAppBuilder({
        ...
        disclosures: {
          excludedCountries: [
            ...
            "AND","ATG","ALB","ARM","AZE","BIH","BRB","BGD","BEL","BHS","BWA","BLR","CIV","CHL","CRI","CYP","DNK","DMA","DZA","ECU","EST","GEO","GHA","GMB","GRC","HRV","ISR","IND","JAM","KEN","KNA","PRK","KWT","KAZ","LBN","LIE","LTU","LVA","MCO","MNE","MKD","MLT","MDV","NLD","OMN","PER","PHL","POL","PSE","PRT","PRY","SRB","RUS","SAU","SYC","SVN","SMR","SEN","SYR","TJK","TLS","TUR","TWN","UGA","URY","VAT","VCT","VEN","ZWE"
          ],
          nationality: true,
        }
      }).build()
